export default {
    ...
    <ul class="pagination">
      ...
      <li class="page-item" :class="{active: page===current_page}" v-for="page in pages.total_pages" :key="page+123">
...
// 1.頁數 <li class="page-item" :class="{active: page===current_page}" v-for="page in pages.total_pages" :key="page+123">
// v-for="page in pages.total_pages" 取得頁數有幾頁的數字，就去跑幾次迴圈
// :class="{active: page===current_page}" 當page===current_page時class就加上active屬性